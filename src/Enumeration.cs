...
namespace HaidaiTech.Enumeration
{
    public abstract class Enumeration : IComparable
    {
        ...
        protected Enumeration(int id, string name, string? protectedValue = default!)
            => (Id, Name, ProtectedValue) = (id, name, protectedValue);
        ...
        /// <summary>
        /// Converts the current instance to a DTO.
        /// </summary>
        /// <returns>EnumerationDto</returns>

        public EnumerationDto ToDto()
        {
